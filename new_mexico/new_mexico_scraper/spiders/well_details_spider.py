import scrapy
from new_mexico_scraper.models import find_between_r, replace_blanks_clean
from new_mexico_scraper.items import WellDetailsItem
...
class WellDetailsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = ['https://wwwapps.emnrd.state.nm.us/ocd/ocdpermitting/Data/WellDetails.aspx?api=30-039-27335']
